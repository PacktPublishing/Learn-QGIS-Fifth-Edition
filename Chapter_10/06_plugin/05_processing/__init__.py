...
class QgisBookMinimalPlugin:
    ...
    def initGui(self):
        ...
        # Adds the algorithms registered in the provider to the Processing toolbox.
    ...
    def unload(self):
        ...
        # Remove the processing provider and algorithms from the Processing toolbox.
...
class QgisBookMinimalPluginAlgorithmProvider(QgsProcessingProvider):
    ...
    def name(self, *args, **kwargs):
        # This name will appear in GUI.
        return self.tr("QGIS Book Minimal Plugin")

    def icon(self):
        # The icon shown just before the name in the GUI.
        return QIcon(str(Path(__file__).with_name("icon.svg")))

    def loadAlgorithms(self, *args, **kwargs):
        # One plugin can load more than one algorithms.
        self.addAlgorithm(ExchangeRateAlgorithm())
